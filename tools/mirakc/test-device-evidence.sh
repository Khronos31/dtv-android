...
assert module.EXPECTED_PACKAGE_VERSION == "0.3.0"
assert module.EXPECTED_PACKAGE_VERSION_CODE == "300"
...
assert module.parse_package_badging(
    "package: name='dev.khronos31.mirakc' versionCode='300' versionName='0.3.0'"
) == {"package": "dev.khronos31.mirakc", "version_code": "300", "version_name": "0.3.0"}
