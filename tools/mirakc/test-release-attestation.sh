...
with tempfile.TemporaryDirectory(prefix="mirakc-release-attestation-") as temporary:
    ...
    build_info.write_text(json.dumps({
        "schema": 1,
        "candidate": {"build": {"kind": "candidate", "candidate_run_id": "123", "git_ref": "main", "git_head": "a" * 40, "version": "0.3.2", "unsigned_apk_sha256": "f" * 64}, "signed_apk_sha256": candidate_hash, "certificate_sha256": module.CERT},
    }))
    ...
    stale_build_info.write_text(json.dumps({
        "schema": 1,
        "candidate": {"build": {"kind": "candidate", "candidate_run_id": "123", "git_ref": "main", "git_head": "a" * 40, "version": "0.3.2", "unsigned_apk_sha256": "f" * 64}, "signed_apk_sha256": candidate_hash, "certificate_sha256": module.CERT},
        "unknown": {"build": {"kind": "unknown", "version": "0.3.2"}, "signed_apk_sha256": "c" * 64, "certificate_sha256": module.CERT},
    }))
    try:
